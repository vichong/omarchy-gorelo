...
// Copy of the Ui kit Dropdown with per-option icon/colour decoration because
// the kit's Dropdown has no per-option decoration.
Item {
  id: root
  ...
  function optionIcon(o) {
    return (o && typeof o === "object" && o.icon !== undefined) ? String(o.icon) : ""
  }
  function optionColor(o) {
    return (o && typeof o === "object" && o.color !== undefined) ? String(o.color) : ""
  }
  ...
  function currentLabel() {
    ...
    return current === null ? value : optionLabel(current)
  }
  ...
  Column {
    ...
    BorderSurface {
      ...
      Text {
        ...
        text: root.optionIcon(root.currentOption())
        color: root.optionColor(root.currentOption()) !== ""
          ? root.optionColor(root.currentOption()) : root.foreground
        font.family: root.fontFamily
      ...
      Text {
        textFormat: Text.PlainText
        anchors.left: triggerIcon.right
        anchors.right: chevron.left
        anchors.verticalCenter: parent.verticalCenter
        anchors.leftMargin: triggerIcon.text !== "" ? Style.spacing.sm : 0
        ...
        contentItem: ListView {
          ...
          delegate: Rectangle {
            ...
            Text {
              ...
              text: root.optionIcon(modelData)
              color: root.optionColor(modelData) !== ""
                ? root.optionColor(modelData) : root.foreground
              font.family: root.fontFamily
              font.pixelSize: Style.font.body
            }
            ...
            Text {
              textFormat: Text.PlainText
              anchors.left: optionIconText.right
              anchors.right: parent.right
              anchors.verticalCenter: parent.verticalCenter
              anchors.leftMargin: optionIconText.text !== "" ? Style.spacing.sm : 0
